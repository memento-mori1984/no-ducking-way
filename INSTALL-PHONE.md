...
Use **v1.0.4** or newer (proper release signing — not debug).
...
2. Expand **Assets** → download **NoDuckingWay-1.0.4.apk** (~10 MB).
...
1. On PC, copy `NoDuckingWay-1.0.4.apk` to the phone **Download** folder (USB file transfer).
